...
@section('header-button')
    <a href="/login" class="border border-[#D9C6B5] bg-[#F6F1EC] px-6 py-2 text-[#D9C6B5] text-lg">
        login
    </a>
@endsection
...
@section('content')
    <div class="bg-[#F1ECE7] min-h-[calc(100vh-112px)] pt-12 pb-8 px-6">
        ...
        <div class="w-[820px] mx-auto bg-white border border-[#D9C6B5] rounded-md px-40 py-24">
